...
import { chatThinking, chatToolChoice, imageDataUri, reasoningEffort } from "./providers.js";
...
function chatControlParams(input: any, deepSeek: boolean): Record<string, unknown> {
